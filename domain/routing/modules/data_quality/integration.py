"""Integration route skill for data quality tickets."""
...
class IntegrationModule:
    ...
    route_rule_id = "crc_l3_route"
    route_target = "crc_l3_support"
    keywords = ["sync failure", "pipeline", "integration", "sap-to-quickbase", "crash"]
    ...
    def evaluate(self, context: RouteContext, parent_path: list[str]) -> RouteDecision | None:
        ...
        reason = (
            "Validated data quality issue involves sync, pipeline, integration, "
